...
__clsname__ = 'torsurvey'
__author__ = 'Nik Cubrilovic <nikcub@gmail.com>'
__email__ = 'nikcub@gmail.com'
__url__ = 'http://nikcub.github.com/torsurvey'
__license__ = 'BSD'
__copyright__ = 'Copyright (c) 2014, Nik Cubrilovic. All rights reserved.'
...
if __name__ == '__main__':
  from torsurvey.command_utils import run_cl
  sys.exit(run_cl())
